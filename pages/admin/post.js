      ...
      <div className="col-lg-6 m-auto">
        <form>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" name="pageTitle"  />
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">meta description</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="metaDescription"  />
          </div>
          <div class="mb-3">
            <label for="basic-url" class="form-label">URL structure</label>
            <div class="input-group">
              <span class="input-group-text" id="basic-addon3">https://example.com/users/</span>
              <input type="date" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="urlStructure"  />
            </div>
          </div>
          <div class="mb-3">
          ...
          <div class="input-group mb-3">
            <input type="file" class="form-control" id="inputGroupFile02" name="imageUrl" />
            <label class="input-group-text" for="inputGroupFile02">Upload Thumnail image</label>
          </div>
          <div class="mb-3">
            <label for="inputState" class="form-label" name="Category" >Select Category</label>
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              <input type="date" class="form-control" id="basic-url" aria-describedby="basic-addon3" name="publishDate" />
            </div>
          </div>
